package com.jay.developaccumulation.android.Activity.lunchmode;
...
public class SingleInstanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        Log.d(TAG, "SingleInstanceActivity-->onCreate");
    ...
    protected void onNewIntent(Intent intent) {
        ...
        Log.d(TAG, "SingleInstanceActivity-->onNewIntent");
    }
    ...
    private DemoListAdapter getDemoAdapter() {
        return new DemoListAdapter(getDemoData(), new DemoListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DemoListAdapter.DemoItem item) {
                Intent intent = new Intent(SingleInstanceActivity.this, item.getActivity());
