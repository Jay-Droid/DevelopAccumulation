...
public class AndroidListActivity extends AppCompatActivity {
  ...
  private List<DemoListAdapter.DemoItem> getDemoData() {
    ...
    demoList.add(
        new DemoListAdapter.DemoItem("Activity", "Activity生命周期相关", LifecycleActivity.class));
    demoList.add(
        new DemoListAdapter.DemoItem("Fragment", "Fragment相关", FragmentTestActivity.class));
    demoList.add(new DemoListAdapter.DemoItem("Service", "Service相关", ServiceActivity.class));
    demoList.add(
        new DemoListAdapter.DemoItem(
            "BroadcastReceiver", "BroadcastReceiver相关", BroadcastReceiverActivity.class));
    demoList.add(new DemoListAdapter.DemoItem("Handler", "Handler相关", HandlerActivity.class));
    demoList.add(new DemoListAdapter.DemoItem("View", "View相关", ViewActivity.class));
    demoList.add(
        new DemoListAdapter.DemoItem("RecyclerView", "RecyclerView相关", XAdapterActivity.class));
    demoList.add(
        new DemoListAdapter.DemoItem("WebViewActivity", "WebViewActivity", WebViewActivity.class));
    demoList.add(new DemoListAdapter.DemoItem("QRCodeActivity", "相机相关", QRCodeActivity.class));

    demoList.add(
        new DemoListAdapter.DemoItem("DeepLinkWebActivity", "深度链接", DeepLinkWebActivity.class));
    demoList.add(
        new DemoListAdapter.DemoItem("BaiduFaceActivity", "百度人脸识别", BaiduFaceActivity.class));
    return demoList;
  }

  private DemoListAdapter getDemoAdapter() {
    return new DemoListAdapter(
        getDemoData(),
        new DemoListAdapter.OnItemClickListener() {
          @Override
