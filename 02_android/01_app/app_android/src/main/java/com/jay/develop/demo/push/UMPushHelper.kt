package com.jay.develop.demo.push
...
class UMPushHelper {
    ...
    companion object {
        ...
        const val appKey = "5db2dd220cafb2c05f000112"
        const val secretKey = "958811e9de1b3cd143e22ab19cbd1d34"
//        const val appKey = "5cf271ab4ca35744a6001389"
//        const val secretKey = "8a73f4d44a0c7d789ce7951dd6270d84"
    }
    ...
    fun init(demoApplication: Application) {
        ...
        UMConfigure.init(
            demoApplication,
            appKey,//替换为Appkey,服务后台位置：应用管理 -> 应用信息 -> Appkey
            "Umeng",
            UMConfigure.DEVICE_TYPE_PHONE,
            secretKey//替换为秘钥信息,服务后台位置：应用管理 -> 应用信息 -> Umeng Message Secret
        )
