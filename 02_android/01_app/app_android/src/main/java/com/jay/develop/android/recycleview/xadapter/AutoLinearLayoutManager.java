...
public class AutoLinearLayoutManager extends LinearLayoutManager
{
    ...
    public AutoLinearLayoutManager (
            ...
            RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec)
    {
        ...
        for (int i = 0; i < getItemCount(); i++)
        {
            measureScrapChild(recycler, i, View.MeasureSpec.makeMeasureSpec(i, View.MeasureSpec.UNSPECIFIED), View
                    .MeasureSpec.makeMeasureSpec(i, View.MeasureSpec.UNSPECIFIED), mMeasuredDimension);
            ...
            RecyclerView.Recycler recycler, int position, int widthSpec, int heightSpec, int[] measuredDimension)
    {
        ...
        try
        {
            ...
            if (view != null)
            {
                ...
                int childWidthSpec = ViewGroup.getChildMeasureSpec(widthSpec, getPaddingLeft() + getPaddingRight(), p
                        .width);
